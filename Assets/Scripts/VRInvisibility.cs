...
public class VRInvisibility : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            if (controllerDevice.inputDevice.TryGetFeatureValue(UnityEngine.XR.CommonUsages.triggerButton, out bool triggerButtonPressed) && triggerButtonPressed && !isInCooldown)
            {
                ActivateInvisibility();
            }
        }
